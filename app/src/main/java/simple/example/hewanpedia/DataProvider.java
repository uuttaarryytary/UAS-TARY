...
public class DataProvider {
    ...
    private static List<Kucing> initDataUlar(Context ctx) {
        ...
        kucings.add(new Kucing(ctx.getString(R.string.persia_nama), ctx.getString(R.string.persia_asal),
                ctx.getString(R.string.persia_deskripsi), R.drawable.cat_siberian));
        return kucings;
    }
    ...
    private static List<Monyet>initDataBurung(Context ctx) {
        ...
        monyets.add(new Monyet(ctx.getString(R.string.monyet1_nama),ctx.getString(R.string.monyet1_asal) ,
                ctx.getString(R.string.monyet1_deskripsi), R.drawable.monyet_atlantic_titi));
        monyets.add(new Monyet(ctx.getString(R.string.monyet2_nama), ctx.getString(R.string.monyet2_asal),
                ctx.getString(R.string.monyet2_deskripsi), R.drawable.monyet_goeldis_marmoset));
        monyets.add(new Monyet(ctx.getString(R.string.monyet3_nama), ctx.getString(R.string.monyet3_asal),ctx.getString(R.string.monyet3_deskripsi)
                , R.drawable.monyet_white_headed_capuchin));
